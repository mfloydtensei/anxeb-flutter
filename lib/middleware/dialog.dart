...
class ScopeDialogs {
  ...
  ReferencerDialog referencer<V>(
    ...
    return ReferencerDialog<V>(
      ...
      itemWidget: itemWidget ?? (context, item) => Text(item.toString()),
      headerWidget: headerWidget ?? (context) => const SizedBox.shrink(),
      footerWidget: footerWidget ?? (context) => const SizedBox.shrink(),
      emptyWidget: emptyWidget ?? (context) => const SizedBox.shrink(),
